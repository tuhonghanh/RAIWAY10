...
public class Program {
	...
	public static void main (String[] args) {
		...
		department3.id = 3;
		department3.name = "HÃ nh chÃ­nh";
		
		Department department4 = new Department();
		department4.id = 4;
		department4.name = "GiÃ¡m Ä‘á»‘c";
		
		Department department5 = new Department();
		department5.id = 5;
		department5.name = "Káº¿ toÃ¡n";
		...
		account1.fullName = "Nguyá»…n Thá»‹ Hiá»�n";
...
//		account1.createDate = new Date("2020/01/01");
		...
		account2.fullName = "Tráº§n Thanh ThuÃ½";
...
//		account2.createDate = new Date("2020/01/05");
		...
		account3.fullName = "HoÃ ng VÄƒn TÃ¹ng";
		account3.department = department1;
		account3.position = position4;
//		account3.createDate = LocalDate(2020/01/05);
		...
		account4.fullName = "VÅ© Minh HoÃ ng";
...
//		categoryQuestion4.name = "Postman";
		...
		question1.id = 1;
		question1.content = "CÃ¢u há»�i Java";
		...
		question2.id = 2;
		question2.content = "CÃ¢u há»�i Ruby";
		...
		question3.id = 3;
		question3.content = "CÃ¢u há»�i SQL";
		...
		question4.id = 4;
		question4.content = "CÃ¢u há»�i Postman";
		...
		answer1.id = 1;
		answer1.content = "cÃ¢u tráº£ lá»�i Ruby";
		...
		answer2.id = 2;
		answer2.content = "cÃ¢u tráº£ lá»�i SQL";
		answer2.question = question3;
		answer2.isCorrect = true;
		
		Answer answer3 = new Answer();
		answer3.id = 3;
		answer3.content = "cÃ¢u tráº£ lá»�i Java";
		...
		System.out.println("ThÃ´ng tin phÃ²ng ban 1:");
		System.out.println("Name: " + department1.name);
		System.out.println("ID: " + department1.id);
		System.out.println("\n");
		
		System.out.println("ThÃ´ng tin exam 1:");
